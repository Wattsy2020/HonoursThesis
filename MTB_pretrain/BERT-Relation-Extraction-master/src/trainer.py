...
def train_and_fit(args):
    ...
    train_loader = load_dataloaders(args) # train loader holds the MTB dataset
    train_len = len(train_loader)
    logger.info("Loaded %d pre-training samples." % train_len)
    return # calling load_dataloaders creates the pretraining dataset, we don't need to train a model after this
